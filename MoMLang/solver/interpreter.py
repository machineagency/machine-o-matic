...
class Interpreter(cmd.Cmd):
    ...
    MIN_COORDS = (0, 0)
    MAX_COORDS = (100, 100)
    NUM_AXES = len(MachineSolver.get_machine_axes())
    ...
    def dipatch_steps(self, steps):
        ...
        """
        ptn = Interpreter.PHYS_MOTOR_NUMS
        stp = Interpreter.MOTOR_MAP
        physical_steps = {
            ptn[stp[stage.replace("_steps", "")]]:
                steps[stage] for stage in steps
        }
        print physical_steps
        return True
